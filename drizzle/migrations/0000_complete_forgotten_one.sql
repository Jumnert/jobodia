...
CREATE TYPE "public"."job_listings_location_status" AS ENUM('draft', 'published', 'delisted');--> statement-breakpoint
...
CREATE TYPE "public"."job_listing_application_stage" AS ENUM('denied', 'applied', 'interviewed', 'hired');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE TABLE "job_listings" (
	...
	"status" "job_listings_location_status" DEFAULT 'draft' NOT NULL,
...
CREATE TABLE "organization_user_settings" (
	"userId" varchar NOT NULL,
	"organizationId" varchar NOT NULL,
	"newApplicationEmailNotificaitons" boolean DEFAULT false NOT NULL,
